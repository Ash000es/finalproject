...
export const extras = [
  ...
  { title: 'House Red', price: 10, image: '"https://source.unsplash.com/random",', summary: 'our !995 red merlot is famous for its sweet berry tasts, ideal to accompany chicken or fish dishes' }
