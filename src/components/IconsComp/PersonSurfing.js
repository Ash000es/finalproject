...
export function PersonSurfing (props:React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      version='1.1' id='Capa_1' xmlns='http://www.w3.org/2000/svg' xmlnsXlink='http://www.w3.org/1999/xlink' x='0px' y='0px'
      viewBox='0 0 58.861 58.861' style='enable-background:new 0 0 58.861 58.861;' xmlSpace='preserve' {...props}
    >
      <g>
        <g>
          ...
          <path
            style='fill:#010002;' d='M42.328,17.888C26.341-9.145-7.001,24.461,10.352,19.372C25.388,14.964,26.887,34.401,22.1,39.958
