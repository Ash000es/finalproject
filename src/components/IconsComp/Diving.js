...
export function SvgDiving (props:React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      version='1.1' id='Capa_1' xmlns='http://www.w3.org/2000/svg' xmlnsXlink='http://www.w3.org/1999/xlink' x='0px' y='0px'
      viewBox='0 0 431.814 431.814' fill='#0088BC' style='enable-background:new 0 0 431.814 431.814;' xmlSpace='preserve' {...props}
    >
      <g>
